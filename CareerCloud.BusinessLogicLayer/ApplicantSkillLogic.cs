    ...
    public class ApplicantSkillLogic : BaseLogic<ApplicantSkillPoco>
    {
        ...
        protected override void Verify(ApplicantSkillPoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(101, $"StartMonth for ApplicantSkill {poco.Id}" +
                ...
                {
                    exceptions.Add(new ValidationException(104, $"EndYear for ApplicantSkill {poco.Id}" +
                        $" cannot be less then StartYear"));
                }
            }
